...
def test_get_ban_code_config_from_env(dataprep_scanners_config_instance):
    config = dataprep_scanners_config_instance._get_ban_code_config_from_env({"BAN_CODE_ENABLED": "false"})
    assert config == {"ban_code": {"enabled": False}}

def test_get_ban_competitors_config_from_env(dataprep_scanners_config_instance):
    config = dataprep_scanners_config_instance._get_ban_competitors_config_from_env({"BAN_COMPETITORS_ENABLED": "false"})
...
def test_get_gibberish_config_from_env(dataprep_scanners_config_instance):
    config = dataprep_scanners_config_instance._get_gibberish_config_from_env({"GIBBERISH_ENABLED": "false"})
...
def test_get_language_config_from_env(dataprep_scanners_config_instance):
    config = dataprep_scanners_config_instance._get_language_config_from_env({"LANGUAGE_ENABLED": "false"})
